...
const Icons: Record<string, () => JSX.Element> = {
  ...
  book: () => <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M2 3h6a4 4 0 014 4v14a3 3 0 00-3-3H2z"/><path d="M22 3h-6a4 4 0 00-4 4v14a3 3 0 013-3h7z"/></svg>,
...
const navGroups = [
  ...
  { section: 'Akademik', links: [
    { href: '/questions', label: 'Soru Girişi', icon: 'pencil' },
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    <div style={{ display:'flex', flexDirection:'column', height:'100%' }}>
      ...
      <div style={{ padding:'8px', borderTop:'1px solid #E8EEF5', flexShrink:0 }}>
        <div style={{ display:'flex', alignItems:'center', gap:'8px', padding:'8px 10px', borderRadius:'8px', background:'#F8FAFC', marginBottom:'6px' }}>
          <div style={{ width:'28px', height:'28px', borderRadius:'50%', background:'#1B3A6B', flexShrink:0, display:'flex', alignItems:'center', justifyContent:'center', fontSize:'10px', fontWeight:700, color:'#fff' }}>FK</div>
          <div style={{ flex:1, minWidth:0 }}>
            <div style={{ fontSize:'11.5px', fontWeight:600, color:'#1B3A6B', whiteSpace:'nowrap', overflow:'hidden', textOverflow:'ellipsis' }}>Fuat Kocabıçak</div>
  ...
  return (
    <div style={{ display:'flex', height:'100vh', background:'#F8FAFC', overflow:'hidden' }}>
      ...
      {/* Desktop Sidebar */}
      <aside className="desk-sidebar" style={{ width:'220px', background:'#fff', borderRight:'1px solid #E8EEF5', flexShrink:0, overflow:'hidden' }}>
        <SidebarContent />
      </aside>
      ...
      {/* Mobile Drawer */}
      <aside className="mob-drawer" style={{ position:'fixed', top:0, left:0, bottom:0, width:'260px', background:'#fff', zIndex:300, transform:menuOpen?'translateX(0)':'translateX(-100%)', transition:'transform 0.25s ease', boxShadow:'4px 0 24px rgba(0,0,0,0.15)' }}>
        <SidebarContent />
      </aside>
      ...
      <div style={{ flex:1, display:'flex', flexDirection:'column', overflow:'hidden', minWidth:0 }}>
        ...
        <div className="mob-header" style={{ background:'#1B3A6B', padding:'0 16px', height:'52px', display:'flex', alignItems:'center', justifyContent:'space-between', flexShrink:0 }}>
          ...
          <Link href="/dashboard"
            style={{ fontSize:'11px', padding:'5px 10px', borderRadius:'6px', background:'rgba(255,255,255,0.12)', color:'#fff', textDecoration:'none', fontWeight:600, whiteSpace:'nowrap' }}>
            Ana Panel
          </Link>
        </div>
