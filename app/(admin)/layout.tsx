...
const Icons: Record<string, () => JSX.Element> = {
  ...
  accessibility: () => <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="4" r="2"/><path d="M12 7c-3 0-5 1.5-5 4l1 6h2l1-4h2l1 4h2l1-6c0-2.5-2-4-5-4z"/><path d="M9 11l-2 2M15 11l2 2"/></svg>,
}
